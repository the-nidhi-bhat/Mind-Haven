const responses = {
    ...
    mildStress: {
        keywords: [
            ...
            "feeling heavy", "confused", "restless", "breathe", "breathing", "need to breathe",
            "not relaxed", "not calm", "can't relax", "restless"
        ],
        replies: {
    ...
    highStress: {
        keywords: [
            ...
            "mental pressure", "die", "suicide", "kill myself", "end it all", "self harm", "hurt myself",
            "chest tight", "shaking", "sweating", "hyperventilating", "choking feeling", "nauseous", "dizzy",
            "terrified", "frightened", "dread", "unease", "apprehensive",
            "can't take it", "at my limit", "burning out", "exhausted", "snapping", "losing my mind", "losing it", "losing sanity", "total meltdown",
            "helpless", "hopeless", "trapped", "suffocating", "paralyzed", "desperate", "frantic", "worried", "tense", "on edge"
        ],
        replies: {
            ...
            "chest tight": "Pika! Chest feels tight? Try to drop your shoulders. Relax your jaw. Breathe... 🌬️",
            "shaking": "Pika... You're shaking. It's okay. Drink some water? Feel the floor under your feet. 💧",
            "dizzy": "Pika! Sit down or lay down. Keep your eyes on one spot. Breathe slow. Chuu... 🌀",
            "sweating": "Pika! Your body is just reacting. It's okay. Splash some cool water on your face. 🧊",
            "helpless": "Pika... You aren't alone. I am right here with you. One small step at a time. 🐾",
            "hopeless": "Pika... things feel dark right now, but the sun will come up. Just focus on now. ☀️",
            "trapped": "Pika! Take a big breath. You are not stuck. Open a window? Feel the breeze. 🪟",
            "can't take it": "Pika! Stop. Put everything down. Just breathe for one minute. Just one. ⏱️",
            "burning out": "Pika... You've worked so hard. It's time to rest. You are allowed to stop. 💤",
            "exhausted": "Pika... You're tired. Close your eyes for a moment. Rest your heart. Chuu~ ☁️",
            "die": "Pika... Please stay. You matter so much. 🤍 Please talk to someone who can help: Call or text 988. Chuu~",
            "suicide": "Pika! I'm just a bot, but I care! Please reach out to a friend or a hotline like 988. You are loved. 🌟",
            "self harm": "Pika... please be gentle with yourself. Hold an ice cube instead? Talk to me... I'm here. 🧊",
            "hurt myself": "Pika! No... your life is precious. Take a deep breath. Reach out for help. 🤍"
        }
    },
    ...
    lowMood: {
        keywords: [
            "sad", "lonely", "empty", "hopeless", "down", "low", "depressed", "crying",
            "like crying", "feeling alone", "no one understands", "worthless", "demotivated",
            "like crying", "feeling alone", "no one understands", "worthless", "demotivated",
            "lost", "numb", "not happy", "not feeling good", "not good", "not okay", "not great",
            "not well", "not feeling well", "not myself"
        ],
        replies: {
    ...
    story: {
        keywords: [
            "story", "stories", "tell me a story", "bedtime story", "read a story", "story time", "short story",
            "calm story", "relaxing story", "listen to stories", "hear a story", "tell story"
        ],
        replies: {
    ...
    game: {
        keywords: [
            "game", "games", "play", "play a game", "play game", "bored", "play with me", "riddle", "puzzle", "fun", "entertainment",
            "riddles", "let's play"
        ],
        replies: {
    ...
    yoga: {
        keywords: [
            "yoga", "do yoga", "stretch", "stretching", "asana", "pose", "let's do yoga", "yoga session"
        ],
        replies: {
    ...
    exercise: {
        keywords: [
            "exercise", "workout", "gym", "fitness", "move", "training", "let's exercise", "do exercise", "work out"
        ],
        replies: {
